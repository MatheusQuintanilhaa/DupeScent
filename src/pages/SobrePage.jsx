  ...
  return (
    <LegalPage eyebrow="Quem somos" title="Sobre o" titleEm="DupeScent">
      <p>
        ...
        segredo. Existe um mercado inteiro dedicado a recriar essas combinações
        com fidelidade impressionante, por uma fração do preço.
      </p>
      <p>
      ...
      <p>
        ...
        os nomes de perfumes originais são usados apenas para fins de referência
        e comparação.
      </p>
    </LegalPage>
  );
