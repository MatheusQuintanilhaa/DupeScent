...
export default function Card({ item, onClick, index = 0 }) {
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className="group relative bg-gray-50 dark:bg-[#1a1a1a] border border-gray-100 dark:border-[#2a2a2a] p-6 cursor-pointer min-h-[220px] flex flex-col justify-between hover:-translate-y-0.5 transition-transform duration-200"
    >
